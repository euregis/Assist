...
{
    public class FiltroNumInteiro : Filtro
    {
        ...
        public FiltroNumInteiro() { }
        public FiltroNumInteiro(PropertyInfo propriedade, TipoProcura tipoProcura, string nomeExibicao,
             Object valorUsado1, Object valorUsado2, Object valorLimpo1, Object valorLimpo2)
        {
            this.TipoFiltro = TipoFiltro.NumInteiro;
