...
using Assistente.AcessoDados.NHLinq;
...
namespace Assistente.Negocio
{
    ...
    {   
        ...
        public static bool ValidaCaminhoBase()
        {
            if (string.IsNullOrEmpty(Geral.Config.CaminhoBase)
                || !Util.Arquivos.ArquivoExiste(Geral.Config.CaminhoBase + "AssistenteDB.db3"))
                return false;
            else
                BancoDados.CaminhoBase = Geral.Config.CaminhoBase;
